...
export default function Usuarios(props) {
  ...
  const options = {
    ...
    onFilterChange: (changedColumn, filterList, typeFilter,columnIndex, displayData) => {
      ...
      if (arrValues.length > 0) {
        ...
        // } else {
          ...
          filterObject[changedColumn] = `&entity[name]=${encodeURIComponent(arrValues.join().replaceAll(',', '[OR]'))}`;
        // }
       
      } else {
        delete filterObject[changedColumn]; // Elimina la propiedad del objeto si no hay valores seleccionados
      }
      setParametersURL((prev) => ({ ...prev, filter: Object.values(filterObject).join(''), page: 1,filterList }));
    },
    ...
    onColumnSortChange: (changedColumn, direction) => {
      setParametersURL(prev=> ({...prev, orderBy: changedColumn, orderDirection: direction}))
    },
        ...
        <IconButton
          ...
          onClick={() => {
            ...
            setModalConfirm({
              ...
              aceptFunction: () =>
                deleteUser(usuarios[selectedRows.data[0].dataIndex].id, setSelectedRows),
            });
          }}
        >
          <DeleteIcon />
            ...
            <div className="flex min-h-[55px]  pt-3">
              ...
              <span className="relative -top-2">
                <Input
                  ...
                  onChange={(e) => {
                    setParametersURL((prev) => ({ ...prev, filter: `&user[entityCode]=${e.target.value}`, page: 1 }));
                  }}
