      ...
      <Page size={{ width: 200 }} style={styles.page}>
        ...
        <View style={styles.p5}>
          ...
          <View style={styles.infoList}>
            ...
            <View style={styles.infoCell2}>
              <Text>{props.output.departureDate}</Text>
            </View>
          </View>
            ...
            return (
              <View style={[styles.eachProduct, backgroundColor]}>
                ...
                <View style={styles.tableList}>
                  ...
                  <View style={styles.tableCell2}>
                    <Text>
                      {`${product.name} ${product.unitPerPackage != "N/A" ?  product.unitPerPackage : ''}${" "}${product.typePresentationName != 'N/A' ?  product.typePresentationName : ''}${" "}${product.concentrationSize != 'N/A' ?  product.concentrationSize : ''}`}
                    </Text>
                  </View>
                </View>
